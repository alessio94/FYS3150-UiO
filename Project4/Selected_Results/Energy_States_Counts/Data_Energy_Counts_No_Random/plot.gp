...
plot  '10.txt'  u ($1):($2/100000000) ls 1  w linespoints ti sprintf(" 1.0 " ),\
      '14.txt'  u ($1):($2/100000000) ls 2  w linespoints ti sprintf(" 1.4 " ),\
      '18.txt'  u ($1):($2/100000000) ls 3  w linespoints ti sprintf(" 1.8 " ),\
      '22.txt'  u ($1):($2/100000000) ls 4  w linespoints ti sprintf(" 2.2 " ),\
      '24.txt'  u ($1):($2/100000000) ls 5  w linespoints ti sprintf(" 2.4 " ),\
      '26.txt'  u ($1):($2/100000000) ls 6  w linespoints ti sprintf(" 2.6 " ),\
      '30.txt'  u ($1):($2/100000000) ls 7  w linespoints ti sprintf(" 3.0 " )
