...
# Plot del modulo
plot  'Data/0.txt' every ::1 ls 1  w linespoints ti sprintf("E_{%s} = %s",  columnhead(1), columnhead(2)), \
	  'Data/1.txt'  every ::1 ls 2  w linespoints ti sprintf("E_{%s} = %s",  columnhead(1), columnhead(2)), \
	  'Data/2.txt'    every ::1 ls 4  w linespoints ti sprintf("E_{%s} = %s",  columnhead(1), columnhead(2)), \
